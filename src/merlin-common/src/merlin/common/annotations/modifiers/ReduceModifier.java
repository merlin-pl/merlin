...
public class ReduceModifier extends ClassModifier {
	
	private EPackage context;
	
	public ReduceModifier(Map<String, IModifier> modiHandlers) {
		super(modiHandlers);
	}
	
	@Override
	public String modifier() {
		return Modifiers.REDUCE_MODIFIER;
	}
	...
	public void exec(String val, ENamedElement ne) {
		...
		for (String cls : supers) {
			...
			if (sup!=null) c.getESuperTypes().remove(sup);
		}
	}
